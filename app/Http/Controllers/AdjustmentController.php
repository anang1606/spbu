...
class AdjustmentController extends Controller
{
    ...
    public function getProduct($id){
        $lims_product_warehouse_data = Product::where('is_active',true)->get();
    ...
    public function create()
    {
        ...
        return view('adjustment.create', compact('lims_warehouse_list','lims_pos_setting_data'));
    }
    ...
    public function edit($id)
    {
        ...
        $lims_warehouse_list = Warehouse::where('is_active', true)->get();
        $lims_pos_setting_data = PosSetting::latest()->first();
        return view('adjustment.edit', compact('lims_adjustment_data', 'lims_warehouse_list',
        'lims_product_adjustment_data','lims_pos_setting_data'));
    }
