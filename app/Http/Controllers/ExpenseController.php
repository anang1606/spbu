...
class ExpenseController extends Controller
{
    ...
    public function expenseData(Request $request)
    {
        ...
        if (!empty($expenses)) {
            foreach ($expenses as $key => $expense) {
                ...
                $nestedData['amount'] = $expense->amount;
                $nestedData['note'] = $expense->note;
                $nestedData['document'] = $expense->document;
    ...
    public function store(Request $request)
    {
        ...
        if ($document) {
            ...
            $document->move('expense/documents', $documentName);
    ...
    public function edit($id)
    {
        ...
        if ($role->hasPermissionTo('expenses-edit')) {
            ...
            // $lims_expense_data->date = Carbon::parse($lims_expense_data->created_at);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($document) {
            ...
            if($data['old_document']){
                $file_path = 'expense/documents/' . $data['old_document'];
                if (file_exists($file_path)) {
                    unlink($file_path);
                }
            }
        }else{
            $data['document'] = $data['old_document'];
        }
