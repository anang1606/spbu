...
Route::post('bisnis', 'Auth\RegisterController@bisnis')->name('bisnis');

Route::group(['middleware' => 'auth'], function() {
	Route::get('/dashboard', 'HomeController@dashboard');
});

Route::post('pos/product-api', 'CustomController@product_category');

Route::group(['middleware' => ['auth', 'active']], function() {

    Route::get('subscription', 'SubscriptionController@index')->name('subscription');

    Route::get('posisi-keuangan', 'PosisiKeuanganCtrl@index');
    Route::get('posisi-keuangan/data', 'PosisiKeuanganCtrl@data');

    Route::get('jurnal-umum', 'JurnalUmumController@index');
    Route::get('jurnal-umum/harian/{hari}', 'JurnalUmumController@_getDataHarian');
    Route::get('jurnal-umum/bulanan/{bulan}', 'JurnalUmumController@_getDataBulanan');
    Route::get('jurnal-umum/tahunan/{tahun}', 'JurnalUmumController@_getDataTahunan');

    Route::get('buku-besar', 'BukuBesarController@index');
    Route::get('buku-besar/harian/{hari}', 'BukuBesarController@_getDataHarian');
    Route::get('buku-besar/bulanan/{bulan}', 'BukuBesarController@_getDataBulanan');
    Route::get('buku-besar/tahunan/{tahun}', 'BukuBesarController@_getDataTahunan');

    Route::get('laba-rugi', 'LabaRugiController@index');
    Route::get('laba-rugi/data/{tahun}', 'LabaRugiController@data');

    Route::get('neraca-lajur', 'NeracaLajurController@index');
    Route::get('neraca-lajur/harian/{hari}', 'NeracaLajurController@_getDataHarian');
    Route::get('neraca-lajur/bulanan/{bulan}', 'NeracaLajurController@_getDataBulanan');
    Route::get('neraca-lajur/tahunan/{tahun}', 'NeracaLajurController@_getDataTahunan');
	...
	Route::get('ingredients','ProductController@ingredients')->name('product.ingredients');
	Route::get('ingredients/create_ingredients','ProductController@create_ingredients')->name('products.create_ingredients');
	Route::get('ingredients/edit_ingredients/{id}','ProductController@edit_ingredients')->name('products.edit_ingredients');
	...
	Route::get('customer/generate-qr', 'CustomerController@generateQrView');
	Route::post('customer/find-product', 'CustomerController@findProduct');
	...
	Route::get('purchases/purchase-data', 'PurchaseController@purchaseData')->name('purchases.data');
	...
	Route::get('report/product_report_data', 'ReportController@productReportData');
	...
	Route::get('adjustment-customer', 'AdjustmentCustomerController@index');
	Route::post('adjustment-customer/lims_product_search', 'AdjustmentCustomerController@productSearch');
	Route::post('adjustment-customer/check_qty', 'AdjustmentCustomerController@checkQty');
    Route::resource('adjustment-customer', 'AdjustmentCustomerController');
});
