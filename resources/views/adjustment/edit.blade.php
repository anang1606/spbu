                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open([
                                'route' => ['qty_adjustment.update', $lims_adjustment_data->id],
                                'method' => 'put',
                                'files' => true,
                                'id' => 'adjustment-form',
                            ]) !!}
                                                        ...
                                                        @foreach ($lims_product_adjustment_data as $product_adjustment_data)
                                                            <tr>
                                                                ...
                                                                if ($product_adjustment_data->variant_id) {
                                                                    $product_variant = \App\ProductVariant::select('id', 'item_code')
                                                                ...
                                                                <td class="action">
                                                                    <select name="action[]" class="form-control act-val">
                                                                        @if ($product_adjustment_data->action == '+')
                                                                            <option value="+">
                                                                                {{ trans('file.Addition') }}</option>
                                                                            <option value="-">
                                                                                {{ trans('file.Subtraction') }}</option>
                                                                        @else
                                                                            <option value="-">
                                                                                {{ trans('file.Subtraction') }}</option>
                                                                            <option value="+">
