            ...
            $.each(qty, function(index){
                ...
                while(i < qty[index]) {
                    ...
                    {{--  if($('input[name="promo_price"]').is(":checked")) {
                        htmltext += '<span style="text-decoration: line-through;">Rp. '+formatRupiah(price[index].toString())+'</span>Rp. '+(promo_price[index] !== '') ? formatRupiah(promo_price[index].toString()) : '' +'<br>';
                    }  --}}
                    else if($('input[name="price"]').is(":checked")) {
                        htmltext += 'Rp. '+formatRupiah(price[index].toString());
                    }
                    htmltext +='</td>';
                    if(i % 4 == 3)
                        htmltext += '</tr>';
