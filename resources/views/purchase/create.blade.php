                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="created_at" class="form-control" readonly
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="order_discount"
                                                    class="form-control format-rupiah" step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                        ...
                        <form>
                            <div class="row modal-element">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="edit_qty" class="form-control format-rupiah"
                                        step="any">
                                </div>
                                <div class="col-md-4 form-group">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="edit_unit_cost" class="form-control format-rupiah"
                                        step="any">
                                    <input type="hidden" name="edit_unit" />
                                </div>
                            </div>
...
@push('scripts')
    <script type="text/javascript">
        ...
        $("table.order-list").on("click", ".edit-product", function() {
            ...
            $('input[name="edit_discount"]').val(formatRupiah(parseFloat(product_discount[rowindex]).toFixed(0)
                .toString()));
        ...
        $('button[name="update_btn"]').on("click", function() {
            ...
            if (row_unit_operator == '*') {
                product_cost[rowindex] = $('input[name="edit_unit_cost"]').val().replaceAll('.', '') /
                ...
                success: function(data) {
                    ...
                    if (flag) {
                        ...
                        if ($('select[name="status"]').val() == 1)
                            cols +=
                            '<td class="recieved-product-qty d-none"><input type="number" class="form-control recieved" name="recieved[]" value="1" step="any"/><input type="text" class="form-control batch-no d-none" name="batch_no[]" disabled/><input type="text" class="form-control expired-date d-none" name="expired_date[]" disabled/></td>';
        ...
        function calculateRowProductData(quantity) {
            unitConversion();
            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.discount').text(formatRupiah((
                product_discount[
