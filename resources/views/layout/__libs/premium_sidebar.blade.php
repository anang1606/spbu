...
<nav class="side-navbar">
    <span class="brand-big" style="padding: 10px 0;">
        <a style="margin-left: -7px;" href="{{ url('/') }}">
            <img src="{{ url('logo/652475501a47c7b7d45c7ba064048606.png') }}" style="width: 185px;" />
        </a>
    </span>
    <ul id="side-main-menu" class="side-menu list-unstyled">
        ...
        <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>{{ __('file.product') }}</span><span></a>
            <ul id="product" class="collapse list-unstyled ">
                ...
                <li id="printBarcode-menu"><a href="{{ route('product.printBarcode') }}">{{ __('file.print_barcode') }}</a>
                </li>
                @endif
                @if ($adjustment_active)
                <li id="adjustment-list-menu"><a href="{{ route('qty_adjustment.index') }}">{{ trans('file.Adjustment List') }}</a>
                </li>
        ...
        <li id="ingredients"><a href="{{ route('product.ingredients') }}"> <i class="dripicons-cutlery"></i><span>Ingredients</span></a>
        </li>
        @endif
        <?php
        $index_permission_active = DB::table('permissions')
        ...
        ?>
        @if ($index_permission_active)
        <li id="purchase-list-menu"><a href="{{ route('purchases.index') }}"> <i class="dripicons-card"></i><span>{{ __('file.Purchase') }}</span></a>
        </li>
        @endif
        <?php
    ...
    <?php
        ...
        ?>
    {{--  @if ($index_permission_active)
    <li id="quotation-list-menu"><a href="{{ route('quotations.index') }}"> <i class="dripicons-document">
            </i><span>{{ __('file.Quotation') }}</span></a>
    </li>
    @endif  --}}
    <?php
        $index_permission_active = DB::table('permissions')
    ...
    <li class=""><a href="#account" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-briefcase"></i><span>{{ trans('file.Accounting') }}</span></a>
        <ul id="account" class="collapse list-unstyled ">
            ...
            <li id="posisi-keuangan"><a href="{{ url('posisi-keuangan') }}">Posisi Keuangan</a></li>
            <li id="jurnal-umum"><a href="{{ url('jurnal-umum') }}">Jurnal Umum</a></li>
            <li id="buku-besar"><a href="{{ url('buku-besar') }}">Buku Besar</a></li>
            <li id="laba-rugi"><a href="{{ url('laba-rugi') }}">Laba Rugi</a></li>
            <li id="neraca-lajur"><a href="{{ url('neraca-lajur') }}">Neraca Lajur</a></li>
            @endif
    ...
    <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user"></i><span>{{ trans('file.People') }}</span></a>
        <ul id="people" class="collapse list-unstyled ">
            ...
            <li id="customer-list-menu"><a href="{{ route('customer.index') }}">Pelanggan</a></li>
            <?php
            ...
            <li id="supplier-list-menu"><a href="{{ route('supplier.index') }}">Pemasok</a></li>
            <?php
...
@endif-->
    ...
    <li id="discount-plan-list-menu"><a href="{{ route('discount-plans.index') }}">{{ trans('file.Discount Plan') }}</a>
    </li>
    @endif
    ...
    <li id="customer-group-menu"><a href="{{ route('customer_group.index') }}">{{ trans('file.Customer Group') }}</a>
    </li>
    @endif
    ...
    @endif
    <li id="user-menu"><a href="{{ route('user.profile', ['id' => Auth::id()]) }}">{{ trans('file.User Profile') }}</a>
    </li>
    ...
    <li id="reward-point-setting-menu"><a href="{{ route('setting.rewardPoint') }}">{{ trans('file.Reward Point Setting') }}</a>
    </li>
    @endif
