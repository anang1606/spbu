...
@push('scripts')
    <script type="text/javascript">
        ...
        var url = '{{ url('neraca-lajur') }}';

        $('#btn1').click(function() {
            var harian = $('#a1').val();
            var akun = $('#a2').val();
            window.location.href = url + '/harian/' + harian;
        });
        $('#btn2').click(function() {
            var bulan = $('#b1').val();
            var tahun = $('#b2').val();
            var akun = $('#b3').val();
            window.location.href = url + '/bulanan/' + tahun + '-' + bulan;
        });
        $('#btn3').click(function() {
            var tahun = $('#c1').val();
            var akun = $('#c2').val();
            window.location.href = url + '/tahunan/' + tahun;
        });
        $('#btn4').click(function() {
            var harian1 = $('#d1').val();
            var harian2 = $('#d2').val();
            var akun = $('#d3').val();
            window.location.href = url + '/range/' + harian1;
        });
    </script>
@endpush
