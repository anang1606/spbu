                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Logo Faktur *</label>
                                        <input type="file" accept="image/png" name="site_logo" class="form-control" value="" />
                                    </div>
                                ...
                                {{--  <div class="col-md-6 mt-4">
                                    <div class="form-group">
                                        <input type="hidden" readonly name="site_title" class="form-control"
                                            value="@if ($lims_general_setting_data) {{ $lims_general_setting_data->site_title }} @endif"
                                            required />
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endforeach
                                         @if ($lims_general_setting_data->currency_position == 'prefix')
                                            <input type="radio" name="currency_position" class="d-none" value="prefix" checked>
                                        @endif

                                        <input type="hidden" name="invoice_format_hidden" value="{{ $lims_general_setting_data->invoice_format }}">
                                        <input type="hidden" name="invoice_format" value="{{ $lims_general_setting_data->invoice_format }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="developed_by" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" value="{{ $lims_warehouse_all->phone }}" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>{{trans('file.Email')}}</label>
                                                <input type="email" name="email" value="{{ $lims_warehouse_all->email }}" placeholder="example@example.com" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>{{trans('file.Address')}} *</label>
                                                <textarea required class="form-control" rows="3" name="address">{{ $lims_warehouse_all->address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
