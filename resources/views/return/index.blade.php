    ...
    <section>
        <div class="container-fluid">
            ...
            @if (in_array('returns-add', $all_permission))
                <a href="#" data-toggle="modal" data-target="#add-sale-return" class="btn btn-info"><i
    ...
    <script type="text/javascript">
        ...
        function returnDetails(returns) {
            ...
            $.get('return-sale/product_return/' + returns[13], function(data) {
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(returns[15].toString()) + '</td>';
                cols += '<td>' + 'Rp. '+formatRupiah(returns[16].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(returns[17].toString()) + '(' + returns[18] + '%)' + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(returns[19].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
