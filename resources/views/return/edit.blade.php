                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                            ...
                                                            <tr>
                                                                ...
                                                                if ($product_return->variant_id) {
                                                                    $product_variant_data = \App\ProductVariant::select('id', 'item_code')
                                                                        ->FindExactProduct($product_data->id, $product_return->variant_id)
                                                                        ->first();
                                                                ...
                                                                $tax = DB::table('taxes')
                                                                    ->where('rate', $product_return->tax_rate)
                                                                    ->first();
                                                                $unit_name = [];
                                                                $unit_operator = [];
                                                                ...
                                                                <td class="net_unit_price">
                                                                    {{ number_format((float) $product_return->net_unit_price, 0, '.', '.') }}
                                                                </td>
                                                                <td class="discount">
                                                                    {{ number_format((float) $product_return->discount, 0, '.', '.') }}
                                                                </td>
                                                                <td class="tax">
                                                                    {{ number_format((float) $product_return->tax, 0, '.', '.') }}
                                                                </td>
                                                                <td class="sub-total">
                                                                    {{ number_format((float) $product_return->total, 0, '.', '.') }}
                                                                </td>
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th id="total-discount">
                                                            {{ number_format((float) $lims_return_data->total_discount, 0, '.', '.') }}
                                                        </th>
                                                        <th id="total-tax">
                                                            {{ number_format((float) $lims_return_data->total_tax, 0, '.', '.') }}
                                                        </th>
                                                        <th id="total">
                                                            {{ number_format((float) $lims_return_data->total_price, 0, '.', '.') }}
                                                        </th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
...
@push('scripts')
    <script type="text/javascript">
        ...
        $('#subtotal').text(formatRupiah($('input[name="total_price"]').val().toString()));
        $('#order_tax').text(formatRupiah($('input[name="order_tax"]').val().toString()));
        $('#grand_total').text(formatRupiah($('input[name="grand_total"]').val().toString()));
        ...
        $("table.order-list").on("click", ".edit-product", function() {
            ...
            if (product_type[pos] == 'standard') {
                ...
                $.each(temp_unit_name, function(key, value) {
                    $('select[name="edit_unit"]').append('<option value="' + key + '">' + value +
                        '</option>');
                });
                $("#edit_unit").show();
            } else {
        ...
        function calculateGrandTotal() {
            ...
            var order_tax = parseFloat($('select[name="order_tax_rate"]').val().replaceAll('.', ''));
            item = ++item + '(' + total_qty + ')';
