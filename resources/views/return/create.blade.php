        ...
        function calculateTotal() {
            ...
            $(".is-return").each(function(i) {
                if ($(this).is(":checked")) {
                    ...
                    $('table.order-list tbody tr:nth-child(' + (i + 1) + ') .sub-total').text(formatRupiah(
                        parseFloat(
                            unit_price * qty).toFixed(0).toString()));
                    $('table.order-list tbody tr:nth-child(' + (i + 1) + ') .tax-value').val(parseFloat(tax)
                        .toFixed(0));
                    $('table.order-list tbody tr:nth-child(' + (i + 1) + ') .tax').text(formatRupiah(parseFloat(tax)
                        .toFixed(0).toString()));
                    item++;
                }
            });
