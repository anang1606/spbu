    ...
    <script type="text/javascript">
        ...
        function transferDetails(transfer) {
            var htmltext = '<strong>{{ trans('file.Date') }}: </strong>' + transfer[0] +
                ...
                '<br><br><div class="row"><div class="col-md-6"><strong>{{ trans('file.From') }}:</strong><br>' + transfer[
            ...
            $.get('transfers/product_transfer/' + transfer[3], function(data) {
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(transfer[10].toString()) + '</td>';
                cols += '<td>' + 'Rp. '+formatRupiah(transfer[11].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(transfer[12].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(transfer[13].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
