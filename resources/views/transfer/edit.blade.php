                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="created_at" class="form-control" readonly value="{{date($general_setting->date_format, strtotime($lims_transfer_data->created_at->toDateString()))}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="shipping_cost" class="form-control" value="{{ number_format($lims_transfer_data->shipping_cost,0,'.','.') }}" step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
...
<script type="text/javascript">
    ...
    $("#transfer-list-menu").addClass("active");
    ...
    function calculateRowProductData(quantity) {
        ...
        if (tax_method[rowindex] == 1) {
            ...
            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_cost').text(formatRupiah(net_unit_cost.toFixed(0).toString()));
            ...
            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.sub-total').text(formatRupiah(sub_total.toFixed(0)));
