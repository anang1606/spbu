  ...
  $(".register-details-btn").on("click", function (e) {
      ...
      $.ajax({
          ...
          success:function(data) {
              ...
              $('#register-details-modal #cash_in_hand').text('Rp. '+formatRupiah(data['cash_in_hand'].toString()));
              $('#register-details-modal #total_sale_amount').text('Rp. '+formatRupiah(data['total_sale_amount'].toString()));
              $('#register-details-modal #total_payment').text('Rp. '+formatRupiah(data['total_payment'].toString()));
              $('#register-details-modal #cash_payment').text('Rp. '+formatRupiah(data['cash_payment'].toString()));
              $('#register-details-modal #credit_card_payment').text('Rp. '+formatRupiah(data['credit_card_payment'].toString()));
              $('#register-details-modal #cheque_payment').text('Rp. '+formatRupiah(data['cheque_payment'].toString()));
              $('#register-details-modal #gift_card_payment').text('Rp. '+formatRupiah(data['gift_card_payment'].toString()));
              $('#register-details-modal #paypal_payment').text('Rp. '+formatRupiah(data['paypal_payment'].toString()));
              $('#register-details-modal #total_sale_return').text('Rp. '+formatRupiah(data['total_sale_return'].toString()));
              $('#register-details-modal #total_expense').text('Rp. '+formatRupiah(data['total_expense'].toString()));
              $('#register-details-modal #total_cash').text('Rp. '+formatRupiah(data['total_cash'].toString()));
