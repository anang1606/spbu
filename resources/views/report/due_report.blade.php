            ...
            <table id="report-table" class="table table-hover">
                ...
                <tbody>
                    @foreach ($lims_sale_data as $key => $sale_data)
                        <tr>
                            <td>{{ $key }}</td>
                            <td>{{ date($general_setting->date_format, strtotime($sale_data->created_at->toDateString())) . ' ' . $sale_data->created_at->toTimeString() }}
                            </td>
                            ...
                            @else
                                <td>0</td>
                            @endif
                            <td>{{ $sale_data->grand_total - $sale_data->paid_amount }}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
