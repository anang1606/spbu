    ...
    <script type="text/javascript">
        ...
        $('#product-report-table').DataTable({
            ...
            'columnDefs': [{
                ...
                {
                    'render': function(data, type, row, meta) {
                        return formatRupiah((data !== null) ? data.toString() : '0')
                    },
                    'targets': [3,5,7,9,11]
                }
            ],
        ...
        function datatable_sum(dt_selector, is_calling_first) {
            if (dt_selector.rows('.selected').any() && is_calling_first) {
                ...
                $(dt_selector.column(5).footer()).html(formatRupiah(dt_selector.cells(rows, 5, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(6).footer()).html('Rp. '+formatRupiah(dt_selector.cells(rows, 6, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(7).footer()).html(formatRupiah(dt_selector.cells(rows, 7, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(8).footer()).html('Rp. '+formatRupiah(dt_selector.cells(rows, 8, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(9).footer()).html(formatRupiah(dt_selector.cells(rows, 9, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(10).footer()).html('Rp. '+formatRupiah(dt_selector.cells(rows, 10, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(11).footer()).html(formatRupiah(dt_selector.cells(rows, 11, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                /*$( dt_selector.column( 12 ).footer() ).html(dt_selector.cells( rows, 12, { page: 'current' } ).data().sum().toFixed(0));
                $( dt_selector.column( 13 ).footer() ).html(dt_selector.cells( rows, 13, { page: 'current' } ).data().sum().toFixed(0));*/
            } else {
                ...
                $(dt_selector.column(5).footer()).html(formatRupiah(dt_selector.column(5, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(6).footer()).html('Rp. '+formatRupiah(dt_selector.column(6, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(7).footer()).html(formatRupiah(dt_selector.column(7, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(8).footer()).html('Rp. '+formatRupiah(dt_selector.column(8, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(9).footer()).html(formatRupiah(dt_selector.column(9, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(10).footer()).html('Rp. '+formatRupiah(dt_selector.column(10, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(11).footer()).html(formatRupiah(dt_selector.column(11, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                /*$( dt_selector.column( 12 ).footer() ).html(dt_selector.column( 12, {page:'current'} ).data().sum().toFixed(0));
                $( dt_selector.column( 13 ).footer() ).html(dt_selector.column( 13, {page:'current'} ).data().sum().toFixed(0));*/
            }
        }
    </script>
@endpush
