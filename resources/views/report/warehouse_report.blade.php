@extends('layout.main') @section('content')
    <section class="forms">
        ...
        <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#warehouse-return" role="tab"
                    data-toggle="tab">{{ trans('file.return') }}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#warehouse-expense" role="tab"
                    data-toggle="tab">{{ trans('file.Expense') }}</a>
            </li>
        </ul>
                        ...
                        <tbody>
                            @foreach ($lims_purchase_data as $key => $purchase)
                                <tr>
                                    ...
                                    <td>{{ $purchase->grand_total - $purchase->paid_amount }}
                                    </td>
                        ...
                        <tbody>
                            @foreach ($lims_quotation_data as $key => $quotation)
                                <tr>
                                    ...
                                    ?>
                                    <td>{{ date($general_setting->date_format, strtotime($quotation->created_at->toDateString())) }}<br>{{ $quotation->created_at->toTimeString() }}
                                    </td>
                    ...
                    <table id="return-table" class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($lims_return_data as $key => $return)
                                <tr>
                                    <td>{{ $key }}</td>
                                    <td>{{ date($general_setting->date_format, strtotime($return->created_at->toDateString())) }}<br>{{ $return->created_at->toTimeString() }}
                                    </td>
                    ...
                    <table id="expense-table" class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($lims_expense_data as $key => $expense)
                                <tr>
                                    <td>{{ $key }}</td>
                                    <td>{{ date($general_setting->date_format, strtotime($expense->created_at->toDateString())) }}<br>{{ $expense->created_at->toTimeString() }}
                                    </td>
