                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="created_at" class="form-control date"
                                                    readonly value="{{ date('Y-m-d') }}" placeholder="Choose date"
                ...
                <div id="shipping-cost-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div role="document" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="text" name="shipping_cost" class="form-control numkey format-rupiah"
...
@push('scripts')
    <script type="text/javascript">
        ...
        $(".payment-btn").on("click", function() {
            var audio = $("#mysoundclip2")[0];
            audio.play();
            $('input[name="paid_amount"]').val($("#grand-total").text().replaceAll('.', ''));
            $('input[name="paying_amount"]').val($("#grand-total").text().replaceAll('.', ''));
            $('.qc').data('initial', 1);
        });
