            ...
            <div class="card">
                ...
                <div class="row ml-1 mr-1 mt-2">
                    ...
                    <div class="col-md-3">
                        ...
                        {{--  <input type="hidden" name="warehouse_id" id="warehouse_id" value="{{ $lims_warehouse_list[0]->id }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="paying_amount" class="form-control numkey format-rupiah" step="any"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label>{{ trans('file.Paying Amount') }} *</label>
                            <input type="text" id="amount" name="amount" class="form-control" readonly step="any"
                                required>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label>{{ trans('file.Recieved Amount') }} *</label>
                            <input type="text" name="edit_paying_amount" class="form-control numkey format-rupiah" step="any"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label>{{ trans('file.Paying Amount') }} *</label>
                            <input type="text" name="edit_amount" class="form-control" readonly step="any" required>
                        </div>
                        <div class="col-md-6 mt-1">
                            <label>{{ trans('file.Change') }} : </label>
                            <p class="change ml-2">0</p>
...
@push('scripts')
    <script type="text/javascript">
        ...
        $(document).on("click", "table.sale-list tbody .get-payment", function(event) {
            ...
            $.get('sales/getpayment/' + id, function(data) {
                ...
                $.each(payment_date, function(index) {
                    ...
                    cols += '<td>' + formatRupiah(paid_amount[index].toString()) + '</td>';
        ...
        $('input[name="paying_amount"]').on("input", function() {
            $(".change").text(formatRupiah(parseFloat($(this).val().replaceAll('.','') - $('input[name="amount"]').val().replaceAll('.','')).toFixed(0).toString()));
        });
        ...
        function datatable_sum(dt_selector, is_calling_first) {
            if (dt_selector.rows('.selected').any() && is_calling_first) {
                ...
                $(dt_selector.column(8).footer()).html('Rp. '+formatRupiah(dt_selector.cells(rows, 8, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
                $(dt_selector.column(9).footer()).html('Rp. '+formatRupiah(dt_selector.cells(rows, 9, {
                    page: 'current'
                }).data().sum().toFixed(0).toString()));
            } else {
                $(dt_selector.column(7).footer()).html('Rp. '+formatRupiah(dt_selector.cells(rows, 7, {
        ...
        function saleDetails(sale) {
            ...
            $.get('sales/product_sale/' + sale[13], function(data) {
                ...
                $.each(name_code, function(index) {
                    ...
                    cols += '<td>' + 'Rp. '+formatRupiah(parseFloat(subtotal[index] / qty[index]).toFixed(0)
                        .toString()) + '</td>';
                    cols += '<td>' + 'Rp. '+formatRupiah(tax[index].toString()) + '(' + tax_rate[index] + '%)' + '</td>';
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(sale[14].toString()) + '</td>';
                cols += '<td>' + 'Rp. '+formatRupiah(sale[15].toString()) + '</td>';
                cols += '<td>' + 'Rp. '+formatRupiah(sale[16].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(sale[17].toString()) + '(' + sale[18] + '%)' + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(sale[19].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                if (sale[28]) {
                    var newRow = $("<tr>");
                    cols = '';
                    cols += '<td colspan=7><strong>{{ trans('file.Coupon Discount') }} [' + sale[28] +
                        ']:</strong></td>';
                    cols += '<td>' + 'Rp. '+formatRupiah(sale[29].toString()) + '</td>';
                    newRow.append(cols);
                    newBody.append(newRow);
                }
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(sale[20].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(sale[21].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(sale[22].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(parseFloat(sale[21] - sale[22]).toFixed(0).toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
        ...
        $(document).on('submit', '.payment-form', function(e) {
            if ($('input[name="paying_amount"]').val() < parseFloat($('#amount').val())) {
                ...
                $(".change").text(parseFloat($('input[name="edit_paying_amount"]').val() - $(
                    'input[name="edit_amount"]').val()).toFixed(0));
                e.preventDefault();
            }
