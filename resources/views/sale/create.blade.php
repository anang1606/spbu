                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="paying_amount" class="form-control format-rupiah"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="paid_amount" class="form-control format-rupiah"
                                                        id="paid-amount" step="any" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label id="label-change">{{ trans('file.Change') }}</label>
                        ...
                        <form>
                            <div class="row modal-element">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" step="any" name="edit_qty" class="form-control format-rupiah numkey">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{ trans('file.Unit Discount') }}</label>
                                    <input type="text" name="edit_discount" class="form-control format-rupiah numkey">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{ trans('file.Unit Price') }}</label>
                                    <input type="text" name="edit_unit_price" class="form-control format-rupiah numkey"
                                        step="any">
                                </div>
                                <?php
                                $tax_name_all[] = 'No Tax';
...
@push('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $.get('getproduct/' + {{ $lims_pos_setting_data->warehouse_id }}, function(data) {
                lims_product_array = [];
                product_code = data[0];
                product_name = data[1];
                product_qty = data[2];
            ...
            isCashRegisterAvailable({{ $lims_pos_setting_data->warehouse_id }});
        });
        ...
        function calculateRowProductData(quantity) {
            ...
            if (tax_method[rowindex] == 1) {
                ...
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_price').text(formatRupiah(
                    net_unit_price.toFixed(0).toString()));
        ...
        function calculateGrandTotal() {
            ...
            if ($('select[name="payment_status"]').val() == 4) {
                $('#paying-amount').val('');
                $('#paid-amount').val(formatRupiah(grand_total.toFixed(0).toString()));
            }
            $('input[name="grand_total"]').val(formatRupiah(grand_total.toFixed(0).toString()));
        }
        ...
        $('select[name="payment_status"]').on("change", function() {
            ...
            if (payment_status == 3 || payment_status == 4) {
                ...
                $('input[name="paying_amount"]').val(formatRupiah($('input[name="grand_total"]').val()));
                $('input[name="paid_amount"]').val(formatRupiah($('input[name="grand_total"]').val()));

                if (payment_status == 4) {
                    $("#label-change").text('Kembalian');
                    $("#paid-amount").prop('readonly', true);
                    $("#paying-amount").prop('readonly', false);
                }
                if (payment_status == 3) {
                    $("#label-change").text('Kurang');
                    $("#paid-amount").prop('readonly', false);
        ...
        $('input[name="paid_amount"]').on("input", function() {
            if ($(this).val().replaceAll('.','') > parseFloat($('input[name="paying_amount"]').val().replaceAll('.',''))) {
                alert('Paying amount cannot be bigger than recieved amount');
                $(this).val('');
            } else if ($(this).val().replaceAll('.','') > parseFloat($('#grand_total').text().replaceAll('.',''))) {
                alert('Paying amount cannot be bigger than grand total');
                $(this).val('');
            }

            $("#change").text(formatRupiah(parseFloat($("#paying-amount").val().replaceAll('.','') - $(this).val().replaceAll('.','')).toFixed(0).toString()));
        ...
        $('input[name="paying_amount"]').on("input", function() {
            $("#change").text(formatRupiah(parseFloat($(this).val().replaceAll('.','') - $("#paid-amount").val().replaceAll('.','')).toFixed(0).toString()));
        });
