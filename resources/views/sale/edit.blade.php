                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="created_at" readonly class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" name="warehouse_id" id="warehouse_id" value="{{ $lims_sale_data->warehouse_id }}" />
                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                        ...
                                                        @foreach ($lims_product_sale_data as $product_sale)
                                                            <tr>
                                                                ...
                                                                <td class="net_unit_price">
                                                                    {{ number_format((float) $product_sale->net_unit_price, 0, '.', '.') }}
                                                                </td>
                                                                <td class="discount">
                                                                    {{ number_format((float) $product_sale->discount, 0, '.', '.') }}
                                                                </td>
                                                                <td class="tax">
                                                                    {{ number_format((float) $product_sale->tax, 0, '.', '.') }}
                                                                </td>
                                                                <td class="sub-total">
                                                                    {{ number_format((float) $product_sale->total, 0, '.', '.') }}
                                                                </td>
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th id="total-discount">
                                                            {{ number_format((float) $lims_sale_data->total_discount, 0, '.', '.') }}
                                                        </th>
                                                        <th id="total-tax">
                                                            {{ number_format((float) $lims_sale_data->total_tax, 0, '.', '.') }}
                                                        </th>
                                                        <th id="total">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="shipping_cost" class="form-control format-rupiah"
                                                    value="{{ number_format($lims_sale_data->shipping_cost,0,'.','.') }}" step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <p class="mt-2 pl-2"><strong
                                                            id="coupon-text">{{ number_format((float) $lims_sale_data->coupon_discount, 0, '.', '.') }}</strong>
                                                    </p>
                                                </div>
                                            </div>
                                        @endif
                        ...
                        <form>
                            <div class="row modal-element">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" step="any" name="edit_qty" class="form-control format-rupiah">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{ trans('file.Unit Discount') }}</label>
                                    <input type="text" name="edit_discount" class="form-control format-rupiah">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{ trans('file.Unit Price') }}</label>
                                    <input type="text" name="edit_unit_price" class="form-control format-rupiah" step="any">
                                </div>
                                <?php
                                $tax_name_all[] = 'No Tax';
                                $tax_rate_all[] = 0;
...
@push('scripts')
    <script type="text/javascript">
        ...
        $('#item').text($('input[name="item"]').val() + '(' + formatRupiah($('input[name="total_qty"]').val().toString()) + ')');
        $('#subtotal').text(formatRupiah(parseFloat($('input[name="total_price"]').val()).toFixed(0).toString()));
        $('#order_tax').text(formatRupiah(parseFloat($('input[name="order_tax"]').val()).toFixed(0).toString()));
        if (!$('input[name="order_discount"]').val())
            $('input[name="order_discount"]').val('0');
        $('#order_discount').text(formatRupiah(parseFloat($('input[name="order_discount"]').val()).toFixed(0).toString()));
        if (!$('input[name="shipping_cost"]').val())
            $('input[name="shipping_cost"]').val('0');
        $('#shipping_cost').text(formatRupiah(parseFloat($('input[name="shipping_cost"]').val()).toFixed(0).toString()));
        $('#grand_total').text(formatRupiah(parseFloat($('input[name="grand_total"]').val()).toFixed(0).toString()));
        ...
        function calculateRowProductData(quantity) {
            ...
            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.discount').text(formatRupiah((product_discount[
                rowindex] * quantity).toFixed(0).toString()));
            ...
            if (tax_method[rowindex] == 1) {
                ...
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_price').text(formatRupiah(net_unit_price
                    .toFixed(0).toString()));
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_price').val(net_unit_price
                    .toFixed(0));
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.tax').text(formatRupiah(tax.toFixed(0).toString()));
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.tax-value').val(tax.toFixed(0));
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.sub-total').text(formatRupiah(sub_total.toFixed(
                    0).toString()));
        ...
        function calculateGrandTotal() {
            ...
            $('#order_tax').text(formatRupiah(order_tax.toFixed(0).toString()));
