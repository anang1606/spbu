        ...
        function quotationDetails(quotation) {
            ...
            $.get('quotations/product_quotation/' + quotation[13], function(data) {
                ...
                $.each(name_code, function(index) {
                    ...
                    cols += '<td>' + 'Rp. '+formatRupiah(tax[index].toString()) + '(' + tax_rate[index] + '%)' +
                        '</td>';
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(quotation[14].toString()) + '</td>';
                cols += '<td>' + 'Rp. '+formatRupiah(quotation[15].toString()) + '</td>';
                cols += '<td>' + 'Rp. '+formatRupiah(quotation[16].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(quotation[17].toString()) + '(' + quotation[18] + '%)' + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(quotation[19].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(quotation[20].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(quotation[21].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
