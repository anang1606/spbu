                                            ...
                                            <div class="table-responsive mt-3">
                                                <table id="myTable" class="table table-hover order-list">
                                                        ...
                                                        @foreach ($lims_product_quotation_data as $product_quotation)
                                                            <tr>
                                                                ...
                                                                if ($product_quotation->variant_id) {
                                                                    $product_variant_data = \App\ProductVariant::select('item_code')
                                                                ...
                                                                <td class="net_unit_price">
                                                                    {{ number_format((float) $product_quotation->net_unit_price, 0, '.', '.') }}
                                                                </td>
                                                                <td class="discount">
                                                                    {{ number_format((float) $product_quotation->discount, 0, '.', '.') }}
                                                                </td>
                                                                <td class="tax">
                                                                    {{ number_format((float) $product_quotation->tax, 0, '.', '.') }}
                                                                </td>
                                                                <td class="sub-total">
                                                                    {{ number_format((float) $product_quotation->total, 0, '.', '.') }}
                                                                </td>
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th id="total-qty">{{ number_format($lims_quotation_data->total_qty,0,'.','.') }}</th>
                                                        <th></th>
                                                        <th id="total-discount">
                                                            {{ number_format((float) $lims_quotation_data->total_discount, 0, '.', '.') }}
                                                        </th>
                                                        <th id="total-tax">
                                                            {{ number_format((float) $lims_quotation_data->total_tax, 0, '.', '.') }}
                                                        </th>
                                                        <th id="total">
                                                            {{ number_format((float) $lims_quotation_data->total_price, 0, '.', '.') }}
                                                        </th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="shipping_cost" class="form-control format-rupiah"
                                                    value="{{ number_format($lims_quotation_data->shipping_cost,0,'.','.') }}" step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
...
@push('scripts')
    <script type="text/javascript">
        ...
        if (!$('input[name="order_discount_value"]').val())
            $('input[name="order_discount_value"]').val('0');
        $('#order_discount').text(formatRupiah(parseFloat($('input[name="order_discount_value"]').val()).toFixed(0)
            .toString()));
