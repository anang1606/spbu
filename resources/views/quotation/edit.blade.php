                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open([
                                'route' => ['quotations.update', $lims_quotation_data->id],
                                'method' => 'put',
                                'files' => true,
                                'id' => 'payment-form',
                            ]) !!}
                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                            ...
                                                            <tr>
                                                                ...
                                                                if ($product_quotation->variant_id) {
                                                                    $product_variant_data = \App\ProductVariant::select('id', 'item_code')
                                                                        ->FindExactProduct($product_data->id, $product_quotation->variant_id)
                                                                        ->first();
                                                                ...
                                                                <td class="net_unit_price">
                                                                    {{ number_format($product_quotation->net_unit_price, 0, '.', '.') }}
                                                                </td>
                                                                <td class="discount">
                                                                    {{ number_format($product_quotation->discount, 0, '.', '.') }}
                                                                </td>
                                                                <td class="tax">
                                                                    {{ number_format($product_quotation->tax, 0, '.', '.') }}
                                                                </td>
                                                                <td class="sub-total">
                                                                    {{ number_format($product_quotation->total, 0, '.', '.') }}
                                                                </td>
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th id="total-discount">
                                                            {{ number_format($lims_quotation_data->total_discount, 0, '.', '.') }}
                                                        </th>
                                                        <th id="total-tax">
                                                            {{ number_format($lims_quotation_data->total_tax, 0, '.', '.') }}
                                                        </th>
                                                        <th id="total">
                                                            {{ number_format($lims_quotation_data->total_price, 0, '.', '.') }}
                                                        </th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
...
@push('scripts')
    <script type="text/javascript">
        ...
        $("#quotation-list-menu").addClass("active");
