    ...
    <section>
        <div class="container-fluid">
            ...
            @if (in_array('purchase-return-add', $all_permission))
                <a href="#" data-toggle="modal" data-target="#add-purchase-return" class="btn btn-info"><i
    ...
    <script type="text/javascript">
        ...
        function returnDetails(returns) {
            ...
            $.get('return-purchase/product_return/' + returns[11], function(data) {
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(returns[12].toString()) + '</td>';
                cols += '<td>' + 'Rp. '+formatRupiah(returns[13].toString()) + '</td>';
                cols += '<td>' + 'Rp. '+formatRupiah(returns[14].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(returns[15].toString()) + '(' + returns[16] + '%)' + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
                ...
                cols += '<td>' + 'Rp. '+formatRupiah(returns[17].toString()) + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
