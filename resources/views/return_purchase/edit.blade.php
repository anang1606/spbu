                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" name="supplier_id" id="customer-id"
                                                value="{{ $lims_return_data->supplier_id }}" />
                                            ...
                                            <div class="table-responsive mt-3">
                                                <table id="myTable" class="table table-hover order-list">
                                                            ...
                                                            <tr>
                                                                ...
                                                                if ($product_return->variant_id) {
                                                                    $product_variant_data = \App\ProductVariant::select('id', 'item_code')
                                                                        ->FindExactProduct($product_return->product_id, $product_return->variant_id)
                                                                        ->first();
                                                                ...
                                                                <td class="net_unit_cost">
                                                                    {{ number_format((float) $product_return->net_unit_cost, 0, '.', '.') }}
                                                                </td>
                                                                <td class="discount">
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th id="total">
                                                            {{ number_format((float) $lims_return_data->total_cost, 0, '.', '.') }}
                                                        </th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
...
@push('scripts')
    <script type="text/javascript">
        ...
        function calculateTotal() {
            ...
            $("#total-tax").text(formatRupiah(total_tax.toFixed(0)));
        ...
        function calculateGrandTotal() {
            ...
            $('#order_tax').text(formatRupiah(order_tax.toFixed(0)));
